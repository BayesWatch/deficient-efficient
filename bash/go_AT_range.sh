...
do
    tmux \
      new-session  "python main.py AT $i -s wkAT_split1_40_2_$i --GPU 0 --wrn_depth 40 --wrn_width 2 --alpha 0 --AT_split 1" \; \
      split-window "python main.py AT $i -s wkAT_split2_40_2_$i --GPU 1 --wrn_depth 40 --wrn_width 2 --alpha 0 --AT_split 2"\; \
...
do
    tmux \
      new-session  "python main.py AT $i -s wkAT_Bsplit1_40_2_$i --GPU 0 --wrn_depth 40 --wrn_width 2 --alpha 0 --AT_split 1 --block Bottle" \; \
      split-window "python main.py AT $i -s wkAT_Bsplit2_40_2_$i --GPU 1 --wrn_depth 40 --wrn_width 2 --alpha 0 --AT_split 2 --block Bottle"\; \
